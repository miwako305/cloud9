	...
	<section>
		<table>
			...
			<tr class="status_false">
                    <?php } ?>
                <th class="now_item"><img src="<?php print $img_dir . $value['img']; ?>" height="100" width="100"></br>
         ...
         <th>
             <form method="post">
                <input type="text" class="input_text_name_width" name="update_name"> &nbsp;&nbsp; <input type="submit"  value= "変更" >
				...
				<th>
					<form method="post">
						<input type="text" class="input_text_stock_width"
