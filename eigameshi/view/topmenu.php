		...
		<div id="header">
			<table class="hedder">
				<tr class="logotitle">
					...
					<a>ようこそ<?php print $user_name . "id" . $user_id ; ?>さん</a>
				</tr>
				<td>
						...
						<div class="item" widh="320" height="100">
							<a class="rabel" height="300" ;weight="200"> <span
								...
								<input type="hidden" name="user_id"
									value="<?php print $user_id; ?>"> <input type="hidden"
									name="item_id" value="<?php print $value['item_id']; ?> "> <select
									name="amount"><?php  for ($i = 1; $i <= 20; $i++) {?><option
